...
LA APP SERA ACCESIBLE EN LA RUTA SIGUIENTE
http://localhost:9092.

ACCESO A LA CONSOLA BASE DE DATOS H2  
http://localhost:9092/h2-console

ESTA APP HA SIDO CREADA CON JAVA SPRINGBOOT CON ARQUITECTURA HEXAGONAL Y UNA BASE DE DATOS H2 
LOS TEST SE LLEVARON A CABO CON MOCKITO Y JUnit
